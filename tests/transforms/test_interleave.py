from epochraft import CheckpointableDataset, interleave, testing
...
def test_interleave_simple() -> None:
    ...
    interleaved_dataset = interleave(datasets).take(10)
...
def test_interleave_weighted() -> None:
    ...
    interleaved_dataset = interleave(datasets, weights=[1, 2]).take(9)
    interleaved_data = list(interleaved_dataset)
...
def test_interleave_checkpointing() -> None:
    ...
    dataset = interleave(datasets, weights=[1, 2])
